...
class PublicAction extends Action
{
    ...
    function showAnonymousMessage()
    {
        if (! (common_config('site','closed') || common_config('site','inviteonly'))) {
            ...
            $m = _('Ésto es %%site.name%%, un [micro-blogging](http://es.wikipedia.org/wiki/Micro' .
                   'blogging) para la UN como herramienta de integración, difusión en pro de la cultura, la educación y el libre pensamiento. Pinta aquí tus ideas');
        }
